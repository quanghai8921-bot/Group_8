        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-12">
          ...
          <div className="space-y-6">
            ...
            <p className="text-sm leading-relaxed text-slate-400">
              ShopeeFood - Trải nghiệm đặt món tuyệt vời nhất. Chúng tôi cam kết
              mang đến những bữa ăn ngon, nóng hổi và giao hàng siêu tốc đến tận
              tay bạn.
            </p>
            <div className="flex gap-4">
              <SocialIconLink href="#" platform="Facebook">
                <Facebook className="w-5 h-5" />
              </SocialIconLink>
              <SocialIconLink href="#" platform="Instagram">
                <Instagram className="w-5 h-5" />
              </SocialIconLink>
              <SocialIconLink href="#" platform="X">
                <X className="w-5 h-5" />
              </SocialIconLink>
              <SocialIconLink href="#" platform="Youtube">
          ...
          <div className="space-y-6">
            ...
            <div className="space-y-3">
              <div className="flex items-start gap-3 text-sm">
                ...
                <span>
                  Khu đô thị mới An Phú Thịnh, Phường Quy Nhơn Đông, Tỉnh Bình
                  Định
                </span>
              </div>
...
function FooterLink({ label, href }: { label: string; href: string }) {
  return (
    <li>
      <Link
        href={href}
        className="text-slate-400 hover:text-[#ee4d2d] hover:translate-x-1 flex items-center transition-all"
      >
...
function AppDownloadButton({
  ...
  return (
    <Button
      variant="outline"
      size="sm"
      className="bg-slate-800 border-slate-700 hover:bg-slate-700 text-xs text-slate-300"
    >
      {icon}
      {label}
    </Button>
