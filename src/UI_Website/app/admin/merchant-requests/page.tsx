      ...
      <div className="flex justify-between items-center">
        <div className="space-y-1">
          <h3 className="text-2xl font-black text-gray-900 tracking-tight">
            Đăng ký & Quản lý Merchant
          </h3>
          <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">
            Duyệt hồ sơ và quản lý trạng thái hoạt động đối tác
          </p>
        </div>
              ...
              >
                <td className="px-6 py-5">
                  <div className="flex items-center gap-4">
                    <div
                      className={`h-10 w-10 rounded-xl flex items-center justify-center font-bold ${req.shopLocked ? "bg-red-50 text-red-500" : "bg-orange-50 text-[#ee4d2d]"}`}
                    >
                ...
                <td className="px-6 py-5">
                  <div className="flex flex-col gap-1">
                    <span
                      className={`inline-flex items-center gap-1.5 px-2.5 py-1 rounded-full text-[10px] font-black uppercase tracking-wider w-fit ${
                        req.status === "Pending"
                    ...
                    {req.status === "Approved" && (
                      <span
                        className={`text-[9px] font-black uppercase px-2 py-0.5 rounded-md w-fit ${req.shopLocked ? "bg-red-100 text-red-600" : "bg-green-100 text-green-600"}`}
                      >
                  ...
                  <div className="flex items-center justify-end gap-2">
                    {req.status === "Pending" ? (
                      ...
                      <>
                        ...
                        <Link
                          href={`/admin/menu?merchantId=${req.merchantId || req.id}`}
                        >
                          <Button
                            variant="ghost"
                            size="sm"
                            className="h-9 px-4 rounded-xl text-[#ee4d2d] hover:bg-orange-50 font-bold text-xs gap-2"
                          >
                        ...
                        <div className="py-6 space-y-6">
                          ...
                          <div className="pt-4 border-t border-gray-100">
                            ...
                            <div className="grid grid-cols-2 gap-3">
                              <div className="relative aspect-video rounded-xl bg-gray-100 border border-gray-200 overflow-hidden group cursor-pointer">
                                <img
                                  src="/Logo.jpg"
                                  alt="CMND/CCCD"
