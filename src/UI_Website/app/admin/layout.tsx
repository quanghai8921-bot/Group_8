        ...
        <div className="flex min-h-screen bg-[#FDFDFD] font-sans relative overflow-x-hidden">
            ...
            >
                ...
                <div className="p-4 flex flex-col h-full">
                    {/* Logo */}
                    <Link href="/admin" className="flex items-center gap-3 mb-10 overflow-hidden">
                    ...
                    <div className="mt-auto pt-6 border-t border-gray-100">
                        <div className={`flex items-center gap-3 p-3 rounded-xl bg-slate-50 mb-4 border border-slate-100 transition-all ${!isSidebarHovered ? 'justify-center p-2' : ''
                            }`}>
                            <Avatar className="h-10 w-10 border-2 border-white shadow-sm shrink-0">
                                <AvatarFallback className="bg-slate-200 text-slate-700 font-black tracking-tighter">SA</AvatarFallback>
                            </Avatar>
                            {isSidebarHovered && (
                                <div className="flex-1 min-w-0 transition-opacity duration-300">
                                    <p className="text-sm font-black text-slate-900 truncate">Hệ Thống Admin</p>
                                    <p className="text-xs text-slate-500 font-medium truncate">Site Owner</p>
                                </div>
                            )}
                        </div>
                        <button
                        ...
                        >
                            ...
                            {isSidebarHovered && <span className="transition-opacity duration-300">Đăng xuất hệ thống</span>}
                        </button>
                    </div>
                </div>
            </aside>
            ...
            <div className={`flex-1 flex flex-col min-h-screen transition-all duration-300 ${isSidebarHovered ? 'lg:pl-72' : 'lg:pl-20'
                ...
                <header className="bg-white px-8 py-5 flex items-center justify-between border-b border-gray-50 sticky top-0 z-30">
                    <div className="flex flex-col">
                        ...
                        <p className="text-xs text-gray-400 font-bold uppercase tracking-widest">Portal dành cho chủ sở hữu website</p>
                    </div>
                    ...
                    <div className="flex items-center gap-6">
                        <div className="flex items-center gap-4">
                            ...
                            <button className="p-2 text-gray-500 hover:bg-gray-50 hover:text-[#ee4d2d] rounded-full transition-colors">
