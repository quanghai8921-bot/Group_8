                    ...
                    {success ? (
                        <div className="bg-white rounded-[32px] shadow-2xl p-10 sm:p-16 text-center transform transition-all animate-in zoom-in-95 duration-500">
                            ...
                            <p className="text-gray-500 text-lg mb-8 max-w-lg mx-auto">
                                Cảm ơn bạn đã đăng ký mở quán trên ShopeeFood. Hồ sơ của bạn đang được duyệt và chúng tôi sẽ liên hệ trong thời gian sớm nhất.
                            </p>
                            <Link href="/">
                        ...
                        <div className="bg-white rounded-[32px] shadow-2xl overflow-hidden border border-gray-100">
                            <div className="bg-orange-50/50 p-6 sm:p-10 border-b border-orange-100/50 text-center">
                                <h2 className="text-2xl sm:text-3xl font-black text-gray-900 mb-3">Thông tin đăng ký mở quán</h2>
                                <p className="text-gray-500 font-medium">
                                    Vui lòng cung cấp đầy đủ thông tin để trở thành đối tác nhà hàng của chúng tôi
                                </p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit} className="p-6 sm:p-10 space-y-12">
                                ...
                                <section>
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-800">1. Thông tin chủ quán</h3>
                                    </div>
                                ...
                                <section>
                                    <div className="flex items-center gap-3 mb-6">
                                        ...
                                        <h3 className="text-xl font-bold text-gray-800">2. Thông tin cửa hàng</h3>
                                    </div>

                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6 pl-0 sm:pl-12">
                                        <div className="space-y-2 md:col-span-2">
                                            <Label className="text-xs font-bold text-gray-500 uppercase tracking-wider ml-1">Tên quán</Label>
                                            <div className="relative">
                                                <Input
                                                    name="storeName"
                                                    required
                                        ...
                                        <div className="space-y-2 md:col-span-2">
                                            <Label className="text-xs font-bold text-gray-500 uppercase tracking-wider ml-1">Địa chỉ quán</Label>
                                            <div className="relative">
                                                <Input
                                                    name="address"
                                                    required
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-xs font-bold text-gray-500 uppercase tracking-wider ml-1">Loại hình món ăn</Label>
                                            <div className="relative">
                                                <select
                                                    name="foodType"
                                                    required
                                        ...
                                        <div className="space-y-2">
                                            <Label className="text-xs font-bold text-gray-500 uppercase tracking-wider ml-1">Giờ mở cửa</Label>
                                            <div className="relative">
                                                <Input
                                                    name="openingHours"
                                                    required
