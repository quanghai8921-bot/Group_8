            ...
            <div className="w-full max-w-[550px] bg-white rounded-[40px] shadow-2xl p-10 relative z-10 border border-orange-50">
              ...
              <form onSubmit={processUserRegistration} className="space-y-5">
                <div className="space-y-2">
                  <Label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Họ và tên đầy đủ</Label>
                  <Input
                    placeholder="Ví dụ: Nguyễn Văn A"
                    value={registrationFormData.fullName}
                    onChange={function (e) { updateFormField("fullName", e.target.value); }}
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={function (e) { updateFormField("birthDate", e.target.value); }}
                      className="h-12 border-2 border-gray-50 focus:border-[#ee4d2d] rounded-xl bg-gray-50/30 px-5 font-medium"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={function (e) { updateFormField("phoneNumber", e.target.value.replace(/\D/g, "")); }}
                      className="h-12 border-2 border-gray-50 focus:border-[#ee4d2d] rounded-xl bg-gray-50/30 px-5 font-medium"
                    />
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={function (e) { updateFormField("email", e.target.value); }}
                    className="h-12 border-2 border-gray-50 focus:border-[#ee4d2d] rounded-xl bg-gray-50/30 px-5 font-medium"
                  />
                </div>
                ...
                <div className="space-y-2">
                  ...
                  <Input
                    ...
                    onChange={function (e) { updateFormField("addressDelivery", e.target.value); }}
                    className="h-12 border-2 border-gray-50 focus:border-[#ee4d2d] rounded-xl bg-gray-50/30 px-5 font-medium"
                  />
                </div>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={function (e) { updateFormField("password", e.target.value); }}
                      className="h-12 border-2 border-gray-50 focus:border-[#ee4d2d] rounded-xl bg-gray-50/30 px-5 font-medium"
                    />
                  </div>
                  <div className="space-y-2">
                    ...
                    <Input
                      ...
                      onChange={function (e) { updateFormField("confirmPassword", e.target.value); }}
                      className="h-12 border-2 border-gray-50 focus:border-[#ee4d2d] rounded-xl bg-gray-50/30 px-5 font-medium"
                    />
                  </div>
                </div>
