        ...
        <div className="space-y-8 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-end gap-4">
                <div>
                    ...
                    <p className="text-gray-500 mt-1">Tạo và quản lý mã giảm giá cho khách hàng của bạn</p>
                </div>
                    ...
                    <DialogContent className="sm:max-w-[600px]">
                        ...
                        <div className="grid gap-6 py-4">
                            ...
                            <div className="grid grid-cols-2 gap-4">
                                ...
                                <div className="grid gap-2">
                                    <Label htmlFor="minimumSpend">Giá trị đơn hàng tối thiểu (VND)</Label>
                                    <Input
                                        id="minimumSpend"
                                        type="number"
                                        placeholder="100000"
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                {voucherList.length === 0 && (
                    <div className="col-span-full py-20 bg-gray-50 rounded-3xl border-2 border-dashed border-gray-200 flex flex-col items-center justify-center text-gray-500">
                        ...
                        <p className="text-sm">Nhấn nút trên để tạo mã giảm giá đầu tiên.</p>
                    </div>
                )}
            </div>
            <Pagination
