        ...
        <div className="p-6 border-b border-gray-100 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="relative w-full sm:w-72">
            ...
            <Input
              ...
              className="pl-9 h-10 border-gray-200 bg-gray-50 focus-visible:ring-red-100 rounded-xl"
            />
          </div>
        </div>
          ...
          <table className="w-full text-left border-collapse min-w-[1000px]">
            <thead>
              <tr className="bg-gray-50/50 text-gray-500 text-sm font-semibold border-b border-gray-100">
                ...
                <th className="px-6 py-4 rounded-tr-xl whitespace-nowrap text-right">
                  Total Spent
                </th>
              </tr>
            </thead>
              ...
              {filteredCustomers.map((customer) => (
                ...
                >
                  ...
                  <td className="px-6 py-5 text-center">
                    <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-red-50 text-[#ee4d2d] font-semibold text-sm border border-red-100">
