                ...
                <div className="container max-w-7xl mx-auto px-4 grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    <div className="flex justify-center lg:justify-end">
                        <div className="w-full max-w-[450px] bg-white rounded-3xl shadow-2xl p-10 relative z-10 border border-orange-50">
                            <h2 className="text-2xl font-black text-gray-900 mb-3 tracking-tight">Tìm tài khoản của bạn</h2>
                            <p className="text-sm text-gray-500 mb-8 leading-relaxed">
                                Hãy nhập <span className="font-bold text-gray-700">số di động</span> hoặc <span className="font-bold text-gray-700">email</span> của bạn để bắt đầu khôi phục mật khẩu.
                            </p>

                            <form onSubmit={submitRecoveryRequest} className="space-y-6">
                                <div className="space-y-2">
                                    <Label className="text-[10px] font-black text-gray-400 uppercase tracking-widest ml-1">Email hoặc Số điện thoại</Label>
                                    <Input
                                        type="text"
                                        placeholder="Ví dụ: 09xx xxx xxx"
                                        value={recoveryContact}
                                        onChange={function (e) { setRecoveryContact(e.target.value); }}
                            ...
                            <div className="mt-10 pt-8 border-t-2 border-dashed border-gray-100 text-center">
                                <Link href="/login" className="text-sm text-gray-500 font-bold hover:text-[#ee4d2d] hover:underline flex items-center justify-center gap-2 group transition-colors">
                                    <svg viewBox="0 0 24 24" className="w-5 h-5 fill-current text-gray-300 group-hover:text-[#ee4d2d] transition-colors">
